...
public class MethodInstrumenter extends AbstractMethodInstrumenter {
	 ...
	 */
	private static final String DISPATCH_METHOD_BEFORE_BODY_DESCRIPTOR = Type.getMethodDescriptor(Type.VOID_TYPE, Type.LONG_TYPE, Type.getType(Object.class), Type.getType(Object[].class));
	 ...
	 * descriptor.
	 */
	private static final String DISPATCH_METHOD_AFTER_BODY_DESCRIPTOR = Type.getMethodDescriptor(Type.VOID_TYPE, Type.LONG_TYPE, Type.getType(Object.class), Type.getType(Object[].class),
	...
	private void generateAfterBodyCall(String method) {
		...
		// execute after body
		mv.visitMethodInsn(Opcodes.INVOKEINTERFACE, IHOOK_DISPATCHER_INTERNAL_NAME, method, DISPATCH_METHOD_AFTER_BODY_DESCRIPTOR, true);
	}
	...
	protected void generateBeforeCatchCall() {
		...
		mv.visitMethodInsn(Opcodes.INVOKEINTERFACE, IHOOK_DISPATCHER_INTERNAL_NAME, "dispatchBeforeCatch", DISPATCH_BEFORE_CATCH_DESCRIPTOR, true);
	}
