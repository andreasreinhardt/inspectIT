...
public class ClassCacheModificationTest extends AbstractTestNGLogSupport {
	...
	public void ensureThatFQNIsNotNull(Class<? extends Type> type) throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, ClassCacheModificationException {
		String fqn = null;
		String hash = "hash";
		int modifiers = 0;
	...
	@Test(dataProvider = "types", expectedExceptions = { ClassCacheModificationException.class })
	public void ensureThatNonNull(Class<? extends Type> type) throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, ClassCacheModificationException {
		service.merge(null);
	}
	...
	public void addNewInitializedTypeThatWasNotKnown(Class<? extends Type> type) throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, ClassCacheModificationException {
	...
	@Test(dataProvider = "types", expectedExceptions = { ClassCacheModificationException.class })
	public void addNewUnInitializedTypeThatWasNotKnown(Class<? extends Type> type) throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, ClassCacheModificationException {
		when(lookup.findByFQN(fqn)).thenReturn(null);
		service.lookup = lookup;
	...
	@Test(dataProvider = "types")
	public void addNewInitializedTypeThatIsKnownUninitialized(Class<? extends Type> type) throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, ClassCacheModificationException {
	...
	@Test(dataProvider = "types")
	public void addNewInitializedTypeThatIsKnownInitializedWithDifferentHash(Class<? extends Type> type) throws NoSuchMethodException, SecurityException, InstantiationException,
			IllegalAccessException, IllegalArgumentException, InvocationTargetException, ClassCacheModificationException {
	...
	@Test(dataProvider = "types")
	public void addNewInitializedTypeThatIsKnownInitializedWithSameHash(Class<? extends Type> type) throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, ClassCacheModificationException {
	...
	@Test(dataProvider = "types")
	public void mergeModifiers(Class<? extends Type> type) throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, ClassCacheModificationException {
		String fqn = "fqn";
	...
	@Test(dataProvider = "types")
	public void mergeWithInitializedNewAnnotationReferredTypeThere(Class<? extends Type> clazz) throws ClassCacheModificationException, NoSuchMethodException, SecurityException,
			InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		TypeWithAnnotations c = (TypeWithAnnotations) construct(clazz, fqn, hash, modifiers);

		String annotationFQN = "fqnAnnotation";
		AnnotationType annotation = new AnnotationType(annotationFQN);
		c.addAnnotation(annotation);

		TypeWithAnnotations stored = (TypeWithAnnotations) construct(clazz, fqn, hashStored, modifiers);
	...
	public void mergeWithNotInitializedNewAnnotationReferredTypeThere(Class<? extends Type> clazz) throws Exception {
		...
		TypeWithAnnotations stored = (TypeWithAnnotations) construct(clazz, fqn);
	...
	@Test(dataProvider = "types")
	public void annotationReplacedWithInitialized(Class<? extends Type> clazz) throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, ClassCacheModificationException {
		TypeWithAnnotations t = (TypeWithAnnotations) construct(clazz, fqn, hash, modifiers);
	...
	public void methodAnnotatedReplacedWithWithInitialized(Class<? extends Type> clazz) throws ClassCacheModificationException, NoSuchMethodException, SecurityException, InstantiationException,
	...
	@Test(dataProvider = "typesWithMethods")
	public void methodExceptionReplacedWithWithInitialized(Class<? extends Type> clazz) throws ClassCacheModificationException, NoSuchMethodException, SecurityException, InstantiationException,
			IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		TypeWithMethods t = (TypeWithMethods) construct(clazz, fqn, hash, modifiers);
	...
	public void handleGivenAnnotatedTypeIsNotSupported(Class<? extends Type> clazz) throws Exception {
		...
		TypeWithAnnotations t = (TypeWithAnnotations) construct(clazz, "some");
	...
	public void mergeWithInitializedNewMethodReturnType(Class<? extends Type> clazz) throws Exception {
		...
		Events expected = new Events();
		expected.addEvent(new NodeEvent((Type) stored, NodeEventType.CHANGED, NodeEventDetails.HASH_ADDED, hash));
		expected.addEvent(new NodeEvent((Type) stored, NodeEventType.CHANGED, NodeEventDetails.METHOD_CHANGED_OR_ADDED));
	...
	public void mergeWithInitializedExistingMethodReturnType(Class<? extends Type> clazz) throws Exception {
		...
		Events expected = new Events();
		expected.addEvent(new NodeEvent((Type) c, NodeEventType.CHANGED, NodeEventDetails.HASH_ADDED, hash));
	...
	public void mergeWithNotInitializedNewMethodReturnType(Class<? extends Type> clazz) throws Exception {
		...
		Events expected = new Events();
		expected.addEvent(new NodeEvent((Type) c, NodeEventType.CHANGED, NodeEventDetails.INITIALIZED, hash));
		expected.addEvent(new NodeEvent((Type) stored, NodeEventType.CHANGED, NodeEventDetails.METHOD_CHANGED_OR_ADDED));
	...
	public void mergeWithInitializedNewMethodExceptionThere(Class<? extends Type> clazz) throws Exception {
		...
		Events events = service.merge((Type) given);
	...
	public void mergeWithInitializedNewMethodExceptionNotThere(Class<? extends Type> clazz) throws Exception {
		...
		Events expected = new Events();
		expected.addEvent(new NodeEvent((Type) stored, NodeEventType.CHANGED, NodeEventDetails.HASH_ADDED, hash));
		expected.addEvent(new NodeEvent((Type) exception, NodeEventType.NEW, NodeEventDetails.NOT_INITIALIZED));
		expected.addEvent(new NodeEvent((Type) stored, NodeEventType.CHANGED, NodeEventDetails.METHOD_CHANGED_OR_ADDED));
	...
	public void addNewMethodExceptionThere(Class<? extends Type> clazz) throws Exception {
		...
		Events expected = new Events();
		expected.addEvent(new NodeEvent((Type) given, NodeEventType.NEW, NodeEventDetails.INITIALIZED, hash));
		// expected.addEvent(new NodeEvent((Type) exception, NodeEventType.NEW,
		// NodeEventDetails.NOT_INITIALIZED));
	...
	public void mergeWithInitializedNewMethodAnnotationNotThere(Class<? extends Type> clazz) throws Exception {
		...
		Events expected = new Events();
		expected.addEvent(new NodeEvent((Type) stored, NodeEventType.CHANGED, NodeEventDetails.HASH_ADDED, hash));
		expected.addEvent(new NodeEvent((Type) a, NodeEventType.NEW, NodeEventDetails.NOT_INITIALIZED));
		expected.addEvent(new NodeEvent((Type) stored, NodeEventType.CHANGED, NodeEventDetails.METHOD_CHANGED_OR_ADDED));
