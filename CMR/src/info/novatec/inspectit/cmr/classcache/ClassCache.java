...
import info.novatec.inspectit.cmr.classcache.events.INodeChangeListener;
...
public class ClassCache {
	 ...
	 */
	private List<INodeChangeListener> nodeChangeListeners = new ArrayList<>();
	...
	void init() {
		...
		modificationService.init(this, lookupService);
	}
	 ...
	 */
	synchronized void informNodeChange(NodeEvent e) {
	 ...
	 *            the changes to the structure.
	 */
	synchronized void informReferenceChange(ReferenceEvent e) {
		for (INodeChangeListener listener : nodeChangeListeners) {
	 ...
	 */
	public IClassCacheModification getModificationService() {
	 ...
	 *         cache.
	 */
	public IClassCacheLookup getLookupService() {
